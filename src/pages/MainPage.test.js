...
describe("Given a MainPage page", () => {
  describe("When it rendered", () => {
    test("Then it should show the name of the person", async () => {
      renderWithProviders(<MainPage users={users} />);
      const nameToFind = await screen.findByText(/Tadeoo/i);

      expect(nameToFind).toBeInTheDocument();
    });
  });
});
